"""
Django settings for demoapp1010_dev_137264 project.
...
ROOT_URLCONF = 'demoapp1010_dev_137264.urls'
...
WSGI_APPLICATION = 'demoapp1010_dev_137264.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "demoapp1010 Support <support@demoapp1010-dev-137264.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp1010_dev_137264 API",
    "DESCRIPTION": "API documentation for demoapp1010_dev_137264 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "demoapp1010_dev_137264.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "demoapp1010_dev_137264.storage_backends.AzureStaticStorage"
